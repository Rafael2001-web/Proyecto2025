        ...
        <div class="mt-3">
            ...
            <form id="editForm" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    {{-- Sub Sector --}}
                    <div>
                        <label for="edit_subSector" class="block text-sm font-medium text-gray-700 mb-1">
                    ...
                    {{-- Nivel de Gobierno --}}
                    <div>
                        <label for="edit_nivelGobierno" class="block text-sm font-medium text-gray-700 mb-1">
                            Nivel de Gobierno <span class="text-red-500">*</span>
                        </label>
                        <select id="edit_nivelGobierno" 
                                name="nivelGobierno" 
                                required
                                class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary">
                    ...
                    {{-- Fecha de Creación --}}
                    <div>
                        <label for="edit_fechaCreacion" class="block text-sm font-medium text-gray-700 mb-1">
                            Fecha de Creación
                        </label>
                        <input type="date" 
                               id="edit_fechaCreacion" 
                               name="fechaCreacion"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary">
                    </div>
                </div>
