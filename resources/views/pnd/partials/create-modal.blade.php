{{-- Modal Crear Objetivo PND --}}
<div id="createModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
    <div class="relative top-10 mx-auto p-5 border w-full max-w-2xl shadow-lg rounded-md bg-white">
        <div class="mt-3">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-lg font-medium text-gray-900">Crear Nuevo Objetivo PND</h3>
            ...
            <form id="createForm" action="{{ route('pnd.store') }}" method="POST">
                @csrf
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    {{-- EJE --}}
                    <div>
                        <label for="create_eje" class="block text-sm font-medium text-gray-700 mb-1">
                            EJE <span class="text-red-500">*</span>
                        </label>
                        <select id="create_eje" 
                                name="eje" 
                                required
                    ...
                    {{-- Objetivo Nacional --}}
                    <div>
                        <label for="create_objetivoN" class="block text-sm font-medium text-gray-700 mb-1">
