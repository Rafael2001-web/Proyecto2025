    ...
    <div class="relative top-10 mx-auto p-5 border w-full max-w-2xl shadow-lg rounded-md bg-white">
        <div class="mt-3">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-lg font-medium text-gray-900">Editar Objetivo ODS</h3>
            ...
            <form id="editForm" method="POST">
                ...
                <div class="space-y-4">
                    {{-- Número ODS --}}
                    <div>
                        <label for="edit_odsnum" class="block text-sm font-medium text-gray-700 mb-1">
                            Número ODS <span class="text-red-500">*</span>
                        </label>
                        <select id="edit_odsnum" 
                                name="odsnum" 
                                required
