{{-- Modal Editar Objetivo Institucional --}}
<div id="editModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
    <div class="relative top-10 mx-auto p-5 border w-full max-w-3xl shadow-lg rounded-md bg-white">
        <div class="mt-3">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-lg font-medium text-gray-900">Editar Objetivo Institucional</h3>
            ...
            <form id="editForm" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    {{-- PND --}}
                    <div>
                        <label for="edit_idPnd" class="block text-sm font-medium text-gray-700 mb-1">
                            Plan Nacional de Desarrollo <span class="text-red-500">*</span>
                        </label>
                        <select id="edit_idPnd"
                                name="idPnd"
                                required
                    ...
                    {{-- ODS --}}
                    <div>
                        <label for="edit_idOds" class="block text-sm font-medium text-gray-700 mb-1">
                            ODS Agenda 2030 <span class="text-red-500">*</span>
                        </label>
                        <select id="edit_idOds"
                                name="idOds"
                                required
                                class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary">
                    ...
                    <div>
                        <label for="edit_idobjEstrategico" class="block text-sm font-medium text-gray-700 mb-1">
                            Objetivo Estratégico <span class="text-red-500">*</span>
                        </label>
                        <select id="edit_idobjEstrategico"
                ...
                {{-- Nivel de Alineación --}}
                <div class="mb-4">
                    <label for="edit_nivel_alineacion" class="block text-sm font-medium text-gray-700 mb-1">
                        Nivel de Alineación <span class="text-red-500">*</span>
                    </label>
                    <select id="edit_nivel_alineacion"
                ...
                {{-- Justificación --}}
                <div class="mb-6">
                    <label for="edit_justificacion" class="block text-sm font-medium text-gray-700 mb-1">
                        Justificación
                    </label>
                    <textarea id="edit_justificacion"
                              name="justificacion"
                              rows="4"
                ...
                <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200">
                    ...
                    <button type="submit"
                        ...
                        Actualizar Objetivo Institucional
                    </button>
                </div>
            </form>
        </div>
