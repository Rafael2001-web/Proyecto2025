...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Acceso Denegado - Sistema Integrado de Planificación e Inversión Pública - SIPeIP 2.0</title>
            ...
            <div class="max-w-md w-full mx-auto">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-8 text-center">
                        ...
                        <!-- Código de Error -->
                        <div class="mb-4">
                            <h1 class="text-6xl font-bold text-primary mb-2">403</h1>
                            <h2 class="text-2xl font-semibold text-neutral mb-4">Acceso Denegado</h2>
                        </div>
