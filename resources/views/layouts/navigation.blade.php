<nav x-data="{ open: false }" class="bg-primary border-b border-primary">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('pnd.index')" :active="request()->routeIs('pnd.*')">
                        {{ __('PND') }}
                    </x-nav-link>
                    <x-nav-link :href="route('objEstrategicos.index')" :active="request()->routeIs('objEstrategicos.*')">
                        {{ __('Obj. Estratégicos') }}
                    </x-nav-link>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-gray-200 hover:bg-blue-800 focus:outline-none focus:bg-blue-800 focus:text-gray-200 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-primary">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('pnd.index')" :active="request()->routeIs('pnd.*')">
                {{ __('PND') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('objEstrategicos.index')" :active="request()->routeIs('objEstrategicos.*')">
                {{ __('Obj. Estratégicos') }}
            </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-blue-600 bg-primary">
            <div class="px-4">
